...
public class EventHandlerManager {
    ...
    public EventHandlerManager(
        ...
        Button stopButton,
        Button resetButton,
        List<Label> lastBallsLabels,
        Map<Integer, Label> ballLabelsMap,
        HBox lastBallsBox,
        GridPane historyGrid
    ) {
    ...
    private void drawNextBall() {
        ...
        for (int i = 0; i < lastBallsLabels.size(); i++) {
            ...
            if (i < lastBalls.size()) {
                displayLabel.setText(String.valueOf(lastBalls.get(lastBalls.size() - 1 - i)));
                displayLabel.getStyleClass().setAll("last-ball-label","drawn");
            } else {
